...
void initMTX(int a[], int L, int Y, int x, int y){
 ...
 template<size_t size> void fooy(int x[][size], int a, int o, int R, int G, int B){
   for(int U = 0; U < 5; U++, o++){
 ...
 template<size_t size> void foox(int x[][size], int a, int o, int R, int G, int B){
   for(int U = 0; U < 5; U++, o++){
     for(size_t i = 0; i < size; i++){
       if(x[U][i] == 1){
  //        cout << x[U][i] << ", " << endl;
...
template void fooy<5>(int x[][5], int a, int o, int R, int G, int B);
template void foox<5>(int x[][5], int a, int o, int R, int G, int B);
